...
public class ZState {
    ...
    public boolean restore_from_disk() {
	String fname;
	...
	try {
		...
		if (formtype.equals("IFZS")) {
			...
			System.arraycopy(zm.restart_state.dynamic, 0, dynamic,
				0, zm.header.static_base());
    ...
    public boolean disk_save(int save_pc) {
	String fname;
	Enumeration e, f;
	Object el, el2;
	int i;
	...
	try {
	    // TODO: Fix Save/Restore Location to use Game Filename
	    File file = new File(Platform.getLocation().toOSString(),
		    zm.getGameName() + ".save");

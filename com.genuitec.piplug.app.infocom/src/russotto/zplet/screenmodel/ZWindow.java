...
public class ZWindow {
	...
	if (wrap) {
	    ...
	    Rectangle screenBounds = myscreen.getBounds();
	    while ((residual + charsWidth(linebuffer.toCharArray(), 0, last)) > (screenBounds.width)) {
	...
	// TODO: Cache Fonts being used
	curfont = new Font(Display.getDefault(), fd.getName(), fd.getHeight(),
		style);
    }

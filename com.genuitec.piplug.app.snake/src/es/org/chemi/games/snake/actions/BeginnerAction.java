...
public class BeginnerAction extends Action {
    private MainView view = null;

    public BeginnerAction(String label, MainView view) {
	super(label);
	this.view = view;
    }
	...
	SnakePlugin.trace(this.getClass().getName(),
		"Changing game mode to beginner."); //$NON-NLS-1$

	view.updateActionsUI(Constants.MODE_BEGINNER);
	view.getPreferences().setMode(Constants.MODE_BEGINNER);
